        ...
        <footer className="bg-[#050505] border-t border-brand-white/5 pt-12 pb-8">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              <div className="col-span-1 lg:border-r border-brand-white/5 pr-0 lg:pr-8">
                <Logo className="mb-4 block" />
                <p className="text-brand-white/40 text-[10px] uppercase tracking-wide mb-6">
                  Assessoria especializada em leilões de imóveis.
                </p>
                <div className="flex gap-4 grayscale opacity-40 hover:opacity-100 transition-all">
                  <a href="https://instagram.com/tjinvest" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><Instagram size={14} className="text-brand-white/80 hover:text-brand-gold cursor-pointer transition-colors" /></a>
                  <a href="https://linkedin.com/company/tjinvest" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><Linkedin size={14} className="text-brand-white/80 hover:text-brand-gold cursor-pointer transition-colors" /></a>
                  <a href="https://facebook.com/tjinvest" target="_blank" rel="noopener noreferrer" aria-label="Facebook"><Facebook size={14} className="text-brand-white/80 hover:text-brand-gold cursor-pointer transition-colors" /></a>
                </div>
              </div>
